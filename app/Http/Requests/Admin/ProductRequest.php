...
class ProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'eco_features' => 'required|array|min:1',
            'eco_features.*' => 'required|exists:eco_features,id',
            'eco_feature_values' => 'required|array',
            'eco_feature_values.*' => 'required|numeric|min:0',
    ...
    public function messages(): array
    {
        ...
        return [
            ...
            'eco_features.required' => 'Необходимо выбрать хотя бы одну эко-характеристику',
            'eco_features.array' => 'Некорректный формат эко-характеристик',
            'eco_features.min' => 'Необходимо выбрать хотя бы одну эко-характеристику',
            'eco_features.*.exists' => 'Выбранная эко-характеристика не существует',
            'eco_features.*.required' => 'Необходимо выбрать эко-характеристику',
            'eco_feature_values.required' => 'Необходимо указать значения эко-характеристик',
            'eco_feature_values.array' => 'Некорректный формат значений эко-характеристик',
            'eco_feature_values.*.required' => 'Укажите значение для выбранной эко-характеристики',
            'eco_feature_values.*.numeric' => 'Значение эко-характеристики должно быть числом',
            'eco_feature_values.*.min' => 'Значение эко-характеристики не может быть отрицательным',
